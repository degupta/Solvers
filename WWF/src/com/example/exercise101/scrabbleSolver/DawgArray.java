...
public class DawgArray 
{
	...
	public boolean wordExists(String word)
	{
		...
		while(true)
		{
			...
			childPos = (unsignedToBytes(dawgArray[pos]) << 16) | (unsignedToBytes(dawgArray[pos + 1]) << 8) | (unsignedToBytes(dawgArray[pos + 2]));
	    	childPos = childPos >> 2;
	...
	public boolean isChildEndOFWord(int currentNode, char letter)
	{
		...
		int childPos = (unsignedToBytes(dawgArray[pos]) << 16) | (unsignedToBytes(dawgArray[pos + 1]) << 8) | (unsignedToBytes(dawgArray[pos + 2]));
		childPos = childPos >> 2;
